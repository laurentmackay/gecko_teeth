...
rhs = cartesian_phase_inhibitor_ode_nonlocal_unbounded_nondim(N, gamma, eps, kappa, no_self=no_self);
...
tmin=0;
tburn=-22
T_mid = oscillations_summary(sol_theta, tmesh, tmin=tmin, tmax=0.5*tmesh(end), dotSize=25, ...
